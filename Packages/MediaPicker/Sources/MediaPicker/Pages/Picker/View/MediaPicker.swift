...
public struct MediaPicker<AlbumSelectionContent: View, CameraSelectionContent: View, CameraViewContent: View>: View {
    ...
    /// - cancel closure
    /// - selection view you can embed in your view
    public typealias CameraSelectionClosure = ((@escaping DefaultHandler, @escaping DefaultHandler, CameraSelectionView) -> CameraSelectionContent)
    ...
    public typealias CameraViewClosure = ((LiveCameraView, @escaping DefaultHandler, @escaping DefaultHandler, @escaping DefaultHandler, @escaping DefaultHandler, @escaping DefaultHandler, @escaping DefaultHandler) -> CameraViewContent)
    ...
    private let onChange: MediaPickerHandler
    ...
    public init(isPresented: Binding<Bool>,
                onChange: @escaping MediaPickerHandler,
    ...
    @ViewBuilder
    func cameraSheet(didTakePicture: @escaping DefaultHandler, didPressCancel: @escaping DefaultHandler) -> some View {
...
public extension MediaPicker {
    ...
    func didPressCancelCamera(_ didPressCancelCamera: @escaping DefaultHandler) -> MediaPicker {
        var mediaPicker = self
